const TFSK_URL = "https://theflightsimkit.com";
const TFSK_USER = "";
const TFSK_PASS = "";

class IngamePanelTFSKPanel extends TemplateElement {
    constructor() {
        super(...arguments);
    ...
    connectedCallback() {
        ...
        this.iframeElement = document.getElementById("TFSKPanelIframe");
        ...
        if (this.ingameUi) {
            this.ingameUi.addEventListener("panelActive", (e) => {
                ...
                if (self.iframeElement) {
                    self.iframeElement.src = TFSK_URL;
                }
            });
...
window.customElements.define("ingamepanel-tfsk", IngamePanelTFSKPanel);
checkAutoload();
